...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgFSDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  // -> Configuration Descriptor <-               //
    ...
    USB_CUSTOM_HID_CONFIG_DESC_SIZ,      // wTotalLength:0 => Size of this array
    0x00,     // wTotalLength:1 => Size of this array
...
{
    USB_LEN_DEV_QUALIFIER_DESC,             // bLength => 18 bytes
    USB_DESC_TYPE_DEVICE_QUALIFIER,        // bDescriptorType => Device descriptor
    0x00, 0x02,                                     // bcdUSB => USB 2.0
    0x00,                                           // bDeviceClass
    0x00,                                           // bDeviceSubClass
    0x00,                                           // bDeviceProtocol
    64,                     // bMaxPacketSize0 (EP0 MaxPacketSize)
